...
describe('Sales floor Project', () => {
  it('C183503 Verify as a user, I see that robot asks your name and email while booking an in-store appointment', () => {
    speclib.addTestId('C183503');
    ...
    speclib.addStepAutoNumber("verify 'email' text feild is displaying");
    expect(webChat.emailTextFeild).toBeExisting();
    speclib.addStep('End of step');
  });
});
