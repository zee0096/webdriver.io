...
describe('Sales floor Project', () => {
  it('C183518 Verify as a user, I see the specific message on giving the score "7 to 8" for recommending our bot to a friend.', () => {
    speclib.addTestId('C183518');
    ...
    speclib.addStepAutoNumber(webChat.readMessage(12));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(19));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(22));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(23));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(25));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(27));
    expect(webChat.readMessageNumber(27)).toBeExisting();

    speclib.addStepAutoNumber(webChat.readMessage(28));
    ...
    speclib.addStepAutoNumber("click on '7' Option");
    webChat.clickOnScore(7);

    speclib.addStepAutoNumber(webChat.readMessage(29));
    expect(webChat.readMessageNumber(29)).toBeExisting();

    speclib.addStepAutoNumber(webChat.readMessage(30));
    ...
    speclib.addStepAutoNumber(webChat.readMessage(32));
    expect(webChat.readMessageNumber(32)).toBeExisting();

    speclib.addStepAutoNumber(webChat.readMessage(33));
