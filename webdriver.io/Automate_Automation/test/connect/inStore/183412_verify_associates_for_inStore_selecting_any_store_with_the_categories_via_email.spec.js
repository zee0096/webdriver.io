...
describe('Sales floor Project', () => {
  it('C183412 Verify as a user, I am able to book an in-store appointment with "I have a product questions" option by selecting any store with the categories via email', () => {
    speclib.addTestId('C183412');
