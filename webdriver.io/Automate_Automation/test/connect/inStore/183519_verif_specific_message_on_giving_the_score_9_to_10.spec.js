...
describe('Sales floor Project', () => {
  it('C183519 Verify as a user, I see the specific message on giving the score "9 to 10" for recommending our bot to a friend.', () => {
    speclib.addTestId('C183519');
    ...
    speclib.addStepAutoNumber("click on '9' Option");
    webChat.clickOnScore(9);
