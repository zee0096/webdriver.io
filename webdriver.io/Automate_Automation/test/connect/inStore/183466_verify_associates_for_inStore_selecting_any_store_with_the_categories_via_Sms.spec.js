...
describe('Sales floor Project', () => {
  it('C183466 Verify as a user, I am able to book an in-store appointment with "I have a product questions" option by selecting any store with the categories via SMS', () => {
    speclib.addTestId('C183466');
