...
describe('Sales floor Project', () => {
  it('C184055 Verify as a user I am able to book an in-store appointment with I have a product questions option by selecting any store with the categories via email (W/O live chat)', () => {
    speclib.addTestId('C184055');
