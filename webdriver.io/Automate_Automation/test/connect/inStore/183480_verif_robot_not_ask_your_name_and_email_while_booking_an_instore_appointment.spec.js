...
describe('Sales floor Project', () => {
  it('C183480 Verify as a user, I see that robot does not ask your name and email while booking an in-store appointment with I have product questions.', () => {
    speclib.addTestId('C183480');
