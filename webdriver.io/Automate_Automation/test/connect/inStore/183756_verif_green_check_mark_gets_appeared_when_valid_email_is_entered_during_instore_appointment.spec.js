...
describe('Sales floor Project', () => {
  it('C183756 Verify as a user, green check mark gets appeared when valid email is entered during booking an in-store appointment.', () => {
    speclib.addTestId('C183756');
    ...
    webChat.emailTextFeild.setValue(TEST_DATA.request.sfr.email);
