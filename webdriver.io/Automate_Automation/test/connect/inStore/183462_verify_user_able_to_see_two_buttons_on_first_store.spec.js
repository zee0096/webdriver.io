...
describe('Sales floor Project', () => {
  it('C183462 Verify as a user, I am able to see two buttons on first store', () => {
    speclib.addTestId('C183462');
    ...
    speclib.addStepAutoNumber(webChat.getVerifiedMessage(webChat.confirmButton));
    expect(webChat.confirmButton).toBeExisting();

    speclib.addStepAutoNumber(webChat.getVerifiedMessage(webChat.findAnotherStoreButton));
