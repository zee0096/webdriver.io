...
Sales floor Project`, () => {
  it('C186016 Verify as a shopper I should not see the card Book an appointment in main menu', () => {
    speclib.addTestId('186016');
    ...
    speclib.addStepAutoNumber("verify 'book An Appointment' Card is hidden on menu");
