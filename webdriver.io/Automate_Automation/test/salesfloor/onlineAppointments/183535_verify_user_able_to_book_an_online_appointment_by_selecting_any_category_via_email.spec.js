...
describe('Sales floor Project', () => {
  it('C183535 Verify as a user, I am able to book an online appointment with "I have a product questions" option by selecting any category via email.', () => {
    speclib.addTestId('183535');
