...
describe('Sales floor Project', () => {
  it('C183530 Verify as a user I see that continue button gets enabled after selecting any category while booking an online appointment', () => {
    speclib.addTestId('183530');
    ...
    expect(webChat.listOfCategories.isEnabled() === true);
  });
});
