...
describe('Sales floor Project', () => {
  it('C183753 Verify as a user, green check mark gets appeared when valid phone number is entered during booking an online appointment.', () => {
    speclib.addTestId('183753');
    ...
    speclib.addStepAutoNumber(`enter invalid phone number in phone field: ${TEST_DATA.request.sfr.invalidPhone}`);
    ...
    speclib.addStepAutoNumber(`enter valid phone number in phone field: ${TEST_DATA.request.sfr.phone}`);
    webChat.enterPhoneNumber(TEST_DATA.request.sfr.phone);
