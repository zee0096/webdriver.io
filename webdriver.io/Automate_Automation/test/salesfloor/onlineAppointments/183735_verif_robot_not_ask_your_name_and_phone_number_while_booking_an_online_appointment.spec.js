...
describe('Sales floor Project', () => {
  it('C183735 Verify as a user, I see that robot does not ask your name and phone number while booking an online appointment.', () => {
    speclib.addTestId('183735');
    ...
    speclib.addStepAutoNumber(`enter text in phone field: ${TEST_DATA.request.sfr.phone}`);
    ...
    speclib.addStepAutoNumber(webChat.getClickElementText(webChat.ihaveProductQuestionsSecondOption));
    webChat.ihaveProductQuestionsSecondOption.click();
