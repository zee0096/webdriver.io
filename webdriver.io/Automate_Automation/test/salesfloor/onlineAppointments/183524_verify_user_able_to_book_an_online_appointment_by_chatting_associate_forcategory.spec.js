...
describe('Sales floor Project', () => {
  it('C183524 Verify as a user, I am able to book an online appointment with "I have product questions" by chatting with an associate for any category.', () => {
    speclib.addTestId('183524');
