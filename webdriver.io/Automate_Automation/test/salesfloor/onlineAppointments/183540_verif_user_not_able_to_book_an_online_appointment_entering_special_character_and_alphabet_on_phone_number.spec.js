...
describe('Sales floor Project', () => {
  it('C183540 Verify as a user, I am unable to book an online appointment by entering special character and alphabet on phone number field.', () => {
    speclib.addTestId('183540');
