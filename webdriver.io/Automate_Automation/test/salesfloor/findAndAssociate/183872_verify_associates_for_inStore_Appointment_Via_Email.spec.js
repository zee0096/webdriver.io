...
describe('Sales floor Project', () => {
  it('C183872 Verify as a user, I connect with an associate from list of associates for booking an in-store appointment via email', () => {
    speclib.addTestId('C183872');
