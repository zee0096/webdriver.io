...
describe('Sales floor Project', () => {
  it('C183733 Verify as a user, I am able to get an answer from an associate via email', () => {
    speclib.addTestId('C183733');
    ...
    speclib.addStepAutoNumber("click on 'Get An Answer By Email' Option");
    webChat.getAnAnswerByEmailOptions.click();
    ...
    speclib.addStepAutoNumber('Verify Message is displaying');
    expect(webChat.seventhMessage).toBeExisting();
    speclib.addStep(`verified Message with text '${webChat.getMessageText(webChat.seventhMessage)}' is displaying`);
    ...
    speclib.addStepAutoNumber('Verify Message is displaying');
    expect(webChat.ninthMessage).toBeExisting();
    speclib.addStep(`verified Message with text '${webChat.getMessageText(webChat.ninthMessage)}' is displaying`);
