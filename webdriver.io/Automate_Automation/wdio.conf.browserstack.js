...
const job = jobLong === undefined ? 'Ran manually via console' : jobLong.substring(0, jobLong.indexOf('/'));
const jobname = process.env.BUILD_NUMBER ? `Jenkins # ${process.env.BUILD_NUMBER}` : `Ran from ${process.env.LOGNAME}'s computer`;
...
config.user = 'ambreen_9QW3yg';
config.key = 'NU56pN3gr6q2p8YVsMP8';
