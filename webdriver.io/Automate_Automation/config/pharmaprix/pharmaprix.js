...
module.exports = {
  ...
  hasPhoneInPS      : false,
  sfHTMLTitle_en_US : 'Shop with Testy Rep0 Tester Rep0 - Pharmaprix',
  logoRetailerURL   : 'https://cdn.salesfloor.net/salesfloor-assets/pharmaprix/pharmaprix-logo.png',
  hasAssets         : false,
  ...
  lang : {
    en_US : {
      sf : {
        searchTrackingUrl : 'https://magasiner.pharmaprix.ca/search?lang=en&text=shirt&sf_rep=#REP_NAME&sf_source_origin=storefront',
        htmlTitle         : 'Shop with Testy Rep0 Tester Rep0 - Pharmaprix',
        footerContent     : ['CUSTOMER SERVICE', 'MY ACCOUNT', 'ABOUT BLOOMINGDALE\'S', 'SHOPPING SERVICES'],
        page404           : {
          menuValidation : ['WOMEN', 'SHOES', 'HANDBAGS', 'JEWELRY & ACCESSORIES', 'BEAUTY', 'MEN', 'KIDS',
            'HOME', 'SALE', 'DESIGNERS', 'EDITORIAL', 'GIFTS', 'THE REGISTRY'],
        },
      },
    },
  },
